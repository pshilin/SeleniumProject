...
public class NextTask {
    public static void main(String[] args) throws InterruptedException {
        ...
        String nextTitle ="Etsy - Shop for handmade, vintage, custom, and unique gifts for everyone";
        ...
        String actualNextTitle = driver.getTitle();

        if(actualNextTitle.equals(nextTitle)){
            System.out.println("Pass");
        }else{
            System.out.println("Fail");
        }
